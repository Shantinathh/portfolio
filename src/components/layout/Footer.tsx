export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{ borderTop: '1px solid rgba(59,130,246,0.1)', background: '#020409' }}
      role="contentinfo"
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-blue-400">AI Engineer</div>
          </div>
        </div>

        {/* Copyright */}
        <div className="text-xs text-slate-600 text-center">
          © {currentYear} Shantinath Patil. All rights reserved.
        </div>
